...
def player_input():
    ...
    while not (marker == 'X' or marker == 'O'):
        marker = input('Player 1: Choose Your Character: X or O? ').upper()
...
#Check to see the board mark and its layout, if someone won
...
#Boolean (which space is available)
...
#Continue playing, until game has been ended.
